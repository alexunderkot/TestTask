...
6. Откройте новую консоль и введите команду для подключения: "curl http://localhost:8080", после согласитесь с подключением, введя "Y"

P.s. Вместо подключения через консоль можно перейти по ссылке в браузере (http://localhost:8080)
